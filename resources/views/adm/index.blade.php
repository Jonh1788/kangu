    ...
    <div class="card card-hover">
        <div class="box bg-dark text-center">
            ...
            <form action="../adm/processos?opcao=depositoMin" method="POST" id="editForm3">
                @csrf
                <input type="text" class="form-control custom-input" value="<?php echo $result['deposito_minimo'] ?>" id="valorApostaMax" placeholder="Digite o valor" name="valor" required>
                <br>
                <br>
    ...
    <div class="card card-hover">
        <div class="box bg-dark text-center">
            ...
            <form action="../adm/processos?opcao=saqueMin" method="post" id="editForm3">
                @csrf  
                <input type="text" class="form-control custom-input" value="<?php echo $result['saque_minimo'] ?>" id="valorSaqueMin"   placeholder="Digite o valor" name="valor" required>
                <br>
                <br>
                <button type="submit" class="btn btn-primary">Atualizar</button>
            </form>
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        @csrf    
                <input type="text" class="form-control custom-input" value="" id="valorSaqueMin" placeholder="Digite o valor" name="valor" required>
                <br>
                <br>
                <button type="submit" class="btn btn-primary">Atualizar</button>
            </form>
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        @csrf  
            <input type="text" class="form-control custom-input" value="" id="multiplicador" placeholder="Digite o valor" name="valor" required>
            <br>
            <br>
            <button type="submit" class="btn btn-primary">Atualizar</button>
        </form>
