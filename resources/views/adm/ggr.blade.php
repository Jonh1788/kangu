...
<div class="col-md-6 col-lg-3 col-xlg-3">
  <div class="card card-hover">
    <div class="box bg-dark text-center">
      ...
      <h5>R$</h5>  <h4 class="text-white2" id="valorUsuarios3">{{$total_percas}}</h4>
    </div>
  </div>
</div>
...
<div class="col-md-6 col-lg-3 col-xlg-3">
  <div class="card card-hover">
    <div class="box bg-dark text-center">
      ...
      <h5>R$</h5> <h4 class="text-white2" id="valorUsuarios8">{{$ggr_total}}</h4>
    </div>
  </div>
</div>
...
<div class="col-md-6 col-lg-3 col-xlg-3">
  <div class="card card-hover">
    <div class="box bg-dark text-center">
      ...
      <h4 class="text-yellow" id="valorUsuarios4">{{$ggr_taxa}}</h4><h4>%</h4>
    </div>
  </div>
</div>
</div>
