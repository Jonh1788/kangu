                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div>
                                    <form action="../adm/pixels" method="post">
                                        @csrf
                                        <label for="name">Nome do pixel</label>
                                        <input class="inputC" type="text" id="client_id" name="name" value="">
                                        <label for="code">Código pixel</label>
                                        <textarea class="inputC largeText" type="textarea" id="client_secret" name="code" value=""></textarea>
                                        <label for="url_slug">Url</label>
                                        <select class="inputC" name="url_slug" id="urlSlug">
                                    ...
                                    <table class="tabela">
                                        ...
                                        @foreach ($pixels as $pixel)
                                            <tr class="listaHeader">
                                                <td>{{ $pixel->name }}</td>
                                                <td>{{ $pixel->code }}</td>
                                                <td>{{ $pixel->url_slug }}</td>
                                                <td>
                                                    <button>E</button>
                                                    <button onClick="deletePixel('{{ $pixel->id }}')" >D</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </table>
