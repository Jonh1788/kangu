<!DOCTYPE html><html lang="pt-BR"><head>
    ...
    <title>Hospedagem de Site com Domínio Grátis - HostGator</title>
    ...
    <link href="../css/custom_404.css" rel="stylesheet">
  </head>
  <body>
    <div class="container space">
      <div class="row">
        <div class="col-xs-12 col-sm-5">
          <h3>Erro 404</h3>
          <h1><strong>Ops,</strong><br>Não encontramos<br>essa página!</h1>
          ...
          <a href="https://www.hostgator.com.br" title="HostGator">Conheça-nos!</a>
          <div class="logo">
            <img src="../fonts/logo-hostgator.svg" alt="HostGator">
          </div>
        </div>
        <div class="hidden-xs col-sm-1"></div>
        <div class="hidden-xs col-sm-6">
          <img src="../fonts/illustration-404.svg" class="hidden-xs img-responsive " alt="illustration">
        </div>
      </div>
    </div>
